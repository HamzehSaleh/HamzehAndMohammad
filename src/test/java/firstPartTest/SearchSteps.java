...
//bookClass Book3 = new bookClass("C++","Haya ","12","12347");
   ...
   String []author_array = {"Mohammad","Hamzeh","Haya"};
   String []sign_array = {"10","12","13"};
   String []isbn_array = {"12345","12346","12347"};
   ...
   int k=0 ;
	...
	public void he_entered_the_title_as(String title ) {
		...
		System.out.println(" Test   ... " +title_array[k]+" "+ author_array[k]+"  "+sign_array[k]+"  "+isbn_array[k]+"  ");
